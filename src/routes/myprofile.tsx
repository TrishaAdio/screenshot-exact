...
export const Route = createFileRoute("/myprofile")({
  ...
  head: () => ({
    meta: [
      { title: "My Profile — SymDeals" },
      { name: "description", content: "Manage your SymDeals account details." },
    ],
  }),
});
      ...
      <main className="mx-auto max-w-3xl px-6 py-12 pb-32 lg:pb-12">
        <div>
          ...
          <p className="mt-2 text-[14px] text-muted-foreground">
            Update your account details. Email and password changes require your
            current password.
          </p>
        </div>
  ...
  return (
    <section className="rounded-xl border border-border bg-surface p-6">
      <div className="flex items-start gap-3">
        ...
        <div>
          <h2 className="font-display text-[1.1rem] font-bold tracking-tight text-foreground">
            {title}
          </h2>
